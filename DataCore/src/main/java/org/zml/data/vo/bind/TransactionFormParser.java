...
public class TransactionFormParser extends ServiceFormParser implements IXmlVisitorParserable
{
	public TransactionFormParser()
	{
	}
	public TransactionFormParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof TransactionForm ))  return result;
		TransactionForm objElement = (TransactionForm)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new TransactionForm();
		loadXML((TransactionForm)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof TransactionForm ))  return;
			TransactionForm objElement = (TransactionForm)element;
