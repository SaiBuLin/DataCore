...
public class SQLParserFactory
{
	...
	private static SQLParserAble getQueryDefineInterpreterForNoEquals(CTXMLElement element) throws Exception
	{
		...
		if( element instanceof ActionTools  )
		{
			result = new ActionToolsSQLParser((ActionTools)element);
		}
		else if( element instanceof SelectedPart  )
		{
			result = new SelectedPartSQLParser((SelectedPart)element);
		}
		...
		else if( element instanceof WherePart  )
		{
			result = new WherePartSQLParser((WherePart)element);
		}
		...
		else if( element instanceof ValueAttribute  )
		{
			result = new ValueAttributeSQLParser((ValueAttribute)element);
		}
		else if( element instanceof SqlLibrary  )
		{
			result = new SqlLibrarySQLParser((SqlLibrary)element);
		}
		else if( element instanceof OrderPart  )
		{
			result = new OrderPartSQLParser((OrderPart)element);
		}
		...
		else if( element instanceof FieldsPart  )
		{
			result = new FieldsPartSQLParser((FieldsPart)element);
		}
		...
		else if( element instanceof FormPartGroup  )
		{
			result = new FormPartGroupSQLParser((FormPartGroup)element);
		}
		...
		else if( element instanceof FieldsRelation  )
		{
		...
		else if( element instanceof FormPart  )
		{
			result = new FormPartSQLParser((FormPart)element);
		}
	...
	private static SQLParserAble getQueryDefineInterpreterIndicateClsName(CTXMLElement element) throws Exception
	{
		...
		if( tmpElementClassName.equals(  ActionTools.class.getName())  )
		{
			result = new ActionToolsSQLParser((ActionTools)element);
		}
		else if( tmpElementClassName.equals(  SelectedPart.class.getName())  )
		{
			result = new SelectedPartSQLParser((SelectedPart)element);
		}
		...
		else if( tmpElementClassName.equals(  WherePart.class.getName())  )
		{
			result = new WherePartSQLParser((WherePart)element);
		}
		...
		else if( tmpElementClassName.equals(  ValueAttribute.class.getName())  )
		{
			result = new ValueAttributeSQLParser((ValueAttribute)element);
		}
		...
		else if( tmpElementClassName.equals(  OrderPart.class.getName())  )
		{
			result = new OrderPartSQLParser((OrderPart)element);
		}
		...
		else if( tmpElementClassName.equals(  FieldsPart.class.getName())  )
		{
			result = new FieldsPartSQLParser((FieldsPart)element);
		}
		...
		else if( tmpElementClassName.equals(  FormPartGroup.class.getName())  )
		{
			result = new FormPartGroupSQLParser((FormPartGroup)element);
		}
		...
		else if( tmpElementClassName.equals(  FieldsRelation.class.getName())  )
		{
			result = new FieldsRelationSQLParser((FieldsRelation)element);
		}
		...
		else if( tmpElementClassName.equals(  FormPart.class.getName())  )
		{
			result = new FormPartSQLParser((FormPart)element);
		}
