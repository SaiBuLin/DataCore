...
public class FieldValueBoundaryParser extends BoundaryParser implements IXmlVisitorParserable
{
	public FieldValueBoundaryParser()
	{
	}
	public FieldValueBoundaryParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof FieldValueBoundary ))  return result;
		FieldValueBoundary objElement = (FieldValueBoundary)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new FieldValueBoundary();
		loadXML((FieldValueBoundary)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof FieldValueBoundary ))  return;
			FieldValueBoundary objElement = (FieldValueBoundary)element;
