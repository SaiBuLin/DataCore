...
public class DataFormParser extends FormParser implements IXmlVisitorParserable
{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		objElement.setFormService((FormService)this.getObjectFromElement(node,"formService","FormService"));
	...
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if(  objElement.getFormService()  != null )
			{
				FormService dataOneElement = objElement.getFormService();
				String xmlElementNameEx = "";
				if(UtilTools.isNull( dataOneElement.getXmlElementName() ))
				{
					xmlElementNameEx = this.getRealElementName("formService",dataOneElement.getClass().getName());
				}
				else
				{
					xmlElementNameEx = dataOneElement.getXmlElementName();
