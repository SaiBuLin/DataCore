...
public class ValueAttributeParser extends AttributeParser implements IXmlVisitorParserable
{
	public ValueAttributeParser()
	{
	}
	public ValueAttributeParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof ValueAttribute ))  return result;
		ValueAttribute objElement = (ValueAttribute)element;
	...
	public Object parserNode(Element node)
	{
		...
		loadXML((ValueAttribute)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof ValueAttribute ))  return;
			ValueAttribute objElement = (ValueAttribute)element;
