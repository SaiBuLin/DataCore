...
public class GridSectionParser extends ColumnSectionParser implements IXmlVisitorParserable
{
	public GridSectionParser()
	{
	}
	public GridSectionParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof GridSection ))  return result;
		GridSection objElement = (GridSection)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new GridSection();
		loadXML((GridSection)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof GridSection ))  return;
			GridSection objElement = (GridSection)element;
