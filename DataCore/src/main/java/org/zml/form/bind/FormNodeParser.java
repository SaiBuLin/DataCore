...
public class FormNodeParser extends XMLVisitorParser implements IXmlVisitorParserable
{
	public FormNodeParser()
	{
	}
	public FormNodeParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof FormNode ))  return result;
		FormNode objElement = (FormNode)element;
	...
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof FormNode ))  return;
			FormNode objElement = (FormNode)element;
