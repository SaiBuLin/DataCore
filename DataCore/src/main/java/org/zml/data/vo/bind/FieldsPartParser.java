...
public class FieldsPartParser extends FormPartParser implements IXmlVisitorParserable
{
	public FieldsPartParser()
	{
	}
	public FieldsPartParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof FieldsPart ))  return result;
		FieldsPart objElement = (FieldsPart)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new FieldsPart();
		loadXML((FieldsPart)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof FieldsPart ))  return;
			FieldsPart objElement = (FieldsPart)element;
