...
public class TransactionParser extends SchemaParser implements IXmlVisitorParserable
{
	public TransactionParser()
	{
	}
	public TransactionParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof Transaction ))  return result;
		Transaction objElement = (Transaction)element;
	...
	public Object parserNode(Element node)
	{
		...
		loadXML((Transaction)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof Transaction ))  return;
			Transaction objElement = (Transaction)element;
