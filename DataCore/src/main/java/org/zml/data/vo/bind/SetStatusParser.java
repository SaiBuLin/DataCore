...
public class SetStatusParser extends StatusParser implements IXmlVisitorParserable
{
	public SetStatusParser()
	{
	}
	public SetStatusParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof SetStatus ))  return result;
		SetStatus objElement = (SetStatus)element;
		super.loadXML(element,node);
		objElement.setXmlElementName(node.getName());
		objElement.setLibrary((Library)this.getObjectFromElement(node,"library","Library"));
		objElement.setValidator((Validator)this.getObjectFromElement(node,"validator","Validator"));
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new SetStatus();
		loadXML((SetStatus)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof SetStatus ))  return;
			SetStatus objElement = (SetStatus)element;
			...
			{
				Validator dataOneElement = objElement.getValidator();
				String xmlElementNameEx = "";
				if(UtilTools.isNull( dataOneElement.getXmlElementName() ))
				{
