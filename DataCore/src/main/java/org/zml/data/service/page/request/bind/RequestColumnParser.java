...
public class RequestColumnParser extends RequestPartParser implements IXmlVisitorParserable
{
	public RequestColumnParser()
	{
	}
	public RequestColumnParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof RequestColumn ))  return result;
		RequestColumn objElement = (RequestColumn)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new RequestColumn();
		loadXML((RequestColumn)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof RequestColumn ))  return;
			RequestColumn objElement = (RequestColumn)element;
