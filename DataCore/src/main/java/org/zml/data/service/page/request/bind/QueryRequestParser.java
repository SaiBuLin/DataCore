...
public class QueryRequestParser extends QueryFormNodeParser implements IXmlVisitorParserable
{
	public QueryRequestParser()
	{
	}
	public QueryRequestParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof QueryRequest ))  return result;
		QueryRequest objElement = (QueryRequest)element;
	...
	public Object parserNode(Element node)
	{
		...
		loadXML((QueryRequest)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof QueryRequest ))  return;
			QueryRequest objElement = (QueryRequest)element;
