...
public class VOSchemaParser extends SchemaParser implements IXmlVisitorParserable
{
	public VOSchemaParser()
	{
	}
	public VOSchemaParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof VOSchema ))  return result;
		VOSchema objElement = (VOSchema)element;
	...
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof VOSchema ))  return;
			VOSchema objElement = (VOSchema)element;
