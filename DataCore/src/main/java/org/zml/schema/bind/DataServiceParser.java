...
public class DataServiceParser extends ServiceParser implements IXmlVisitorParserable
{
	public DataServiceParser()
	{
	}
	public DataServiceParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof DataService ))  return result;
		DataService objElement = (DataService)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new DataService();
		loadXML((DataService)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof DataService ))  return;
			DataService objElement = (DataService)element;
