...
public class ServiceConnectToolsParser extends ConnectToolsParser implements IXmlVisitorParserable
{
	public ServiceConnectToolsParser()
	{
	}
	public ServiceConnectToolsParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof ServiceConnectTools ))  return result;
		ServiceConnectTools objElement = (ServiceConnectTools)element;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new ServiceConnectTools();
		loadXML((ServiceConnectTools)result, node);
		return result;
	}
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof ServiceConnectTools ))  return;
			ServiceConnectTools objElement = (ServiceConnectTools)element;
