...
public class RightParser extends DefineParser implements IXmlVisitorParserable
{
	public RightParser()
	{
	}
	public RightParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof Right ))  return result;
		Right objElement = (Right)element;
	...
	public void encodeObjectToElement( Element fatherElement, CTXMLElement element )
	{
		try
		{
			...
			if( !(element instanceof Right ))  return;
			Right objElement = (Right)element;
