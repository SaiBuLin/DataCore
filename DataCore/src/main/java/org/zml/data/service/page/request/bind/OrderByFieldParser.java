...
public class OrderByFieldParser extends SimpleFieldParser implements IXmlVisitorParserable
{
	public OrderByFieldParser()
	{
	}
	public OrderByFieldParser(XMLVisitorFactory thisFactory)
	{
	...
	public boolean loadXML(CTXMLElement element, Element node)
	{
		...
		if( !(element instanceof OrderByField ))  return result;
	...
	public Object parserNode(Element node)
	{
		Object result = null;
		if (node == null) return result;
		result = new OrderByField();
		loadXML((OrderByField)result, node);
		return result;
	}
